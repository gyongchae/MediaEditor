...
m_tSettings[5].POINTER = (void*)(&nAudioIdx2);
m_tSettings[6].POINTER = (void*)(szFileName2);
END_MAPPING_MEMBERS
int nOrder{ 1 };
int nMsgID{ 0 };
int nAudioIdx1{ 0 };
...
m_tSettings[5].POINTER = (void*)(&nWithStation);
m_tSettings[6].POINTER = (void*)(&nFileIdx1);
m_tSettings[7].POINTER = (void*)(szFileName1);
m_tSettings[8].POINTER = (void*)(&nFileIdx2);
m_tSettings[9].POINTER = (void*)(szFileName2);
m_tSettings[10].POINTER = (void*)(&nFileIdx3);
m_tSettings[11].POINTER = (void*)(szFileName3);
m_tSettings[12].POINTER = (void*)(&nFileIdx4);
m_tSettings[13].POINTER = (void*)(szFileName4);
m_tSettings[14].POINTER = (void*)(szDesc);
END_MAPPING_MEMBERS
int nOrder{ 1 };
int nMsgID{ 0 };
int nPlayCount{ 0 };
